...
Definition prim_trpolyK := PrimUnit.prim_trpolyK (n := n) nat_inv_field.
Definition deriv_trpolyK := PrimUnit.deriv_trpolyK (n := n) nat_inv_field.
...
Definition exp_is_morphism := exp_is_morphism_unit
