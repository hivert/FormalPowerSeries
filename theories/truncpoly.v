...
rewrite coef_trXn !coef_trpoly_of_fun le_in1.
case: i le_in1 => //= i; rewrite ltnS => le_in.
by rewrite coef_trXn ltnS le_in (leq_trans le_in le_nm).
Qed.
...
rewrite trXnsV ?leq_pred // -invrM ?unit_trpolyE ?nth0_trXn //.
